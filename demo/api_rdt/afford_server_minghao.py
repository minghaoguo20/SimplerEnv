    ...
    try:
        ...
        class Args:
            def __init__(self, data):
                ...
                self.image_previous_path = data.get("image_previous_path")
        ...
        return jsonify(
            {"normalized_points": normalized_points.tolist(), "points": points.tolist()}
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--port", type=int, help="rdt port", default=5003, required=False
    )
